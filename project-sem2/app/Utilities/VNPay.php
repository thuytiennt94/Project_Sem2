...
class VNPay
{
     ...
     *
     */
    static $vnp_TmnCode = "WTIW8HYO"; //Mã website tại VNPAY
    static $vnp_HashSecret = "FPJSHDQQNFSPZDWVYDSVBDXTTBXPTXGC"; //Chuỗi bí mật
    static $vnp_Url = "https://sandbox.vnpayment.vn/paymentv2/vpcpay.html";
    static string $vnp_Returnurl = "/checkout/vnPayCheck"; //Chú ý cấu hình env('APP_URL') khi sử dụng biến này.
